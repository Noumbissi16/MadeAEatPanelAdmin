          ...
          >
            ...
            >
              <path
                ...
                fill="white"
                className={pathname !== "/" ? s.color : ""}
              />
              <path
                d="M17.6 22.56H6.40002C4.58002 22.56 2.92002 21.16 2.62002 19.37L1.29002 11.4C1.07002 10.16 1.68002 8.57001 2.67002 7.78001L9.60002 2.23001C10.94 1.15001 13.05 1.16001 14.4 2.24001L21.33 7.78001C22.31 8.57001 22.91 10.16 22.71 11.4L21.38 19.36C21.08 21.13 19.38 22.56 17.6 22.56V22.56ZM11.99 2.93001C11.46 2.93001 10.93 3.09001 10.54 3.40001L3.61002 8.96001C3.05002 9.41001 2.65002 10.45 2.77002 11.16L4.10002 19.12C4.28002 20.17 5.33002 21.06 6.40002 21.06H17.6C18.67 21.06 19.72 20.17 19.9 19.11L21.23 11.15C21.34 10.45 20.94 9.39001 20.39 8.95001L13.46 3.41001C13.06 3.09001 12.52 2.93001 11.99 2.93001V2.93001Z"
                fill="white"
          ...
          >
            ...
            >
              <path
                ...
                stroke={pathname !== "/restaurants" ? "#6d7d8b" : "white"}
                strokeWidth="1.5"
                strokeLinecap="round"
